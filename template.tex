...
%% Paper title.
\title{Virtual Reality and Trajectory Visual Analytics, a literature review of use cases and techniques}
...
\item
 Daniel Sikar MSc Data Science part-time student at City University of London, software engineer at Johnson Controls. E-mail: daniel.sikar@city.ac.uk
}
...
%% Abstract section.
\abstract{In this paper we look at published studies in the fields of virtual reality and visual analytics, particularly trajectories, which temporal and spatial movement data seem well suited for the emerging interdisciplinary field sometimes referred to as \textit{Immersive Analytics}. We look at use cases and techniques as well as general costs of these new lines of research and their commercial application, and how accessible the virtual reality techniques described are to the researcher. %
} % end of abstract

%% Keywords that describe your work. Will show as 'Index Terms' in journal
%% please capitalize first letter and insert punctuation after last keyword
\keywords{Immersive analytics, movement data, trajectories visualization, visual analytics, virtual reality}
...
\teaser{
  ...
  \caption{3D scatter-plot and Google Cardboard viewer. Public domain images}
	\label{fig:teaser}
}
...
Since the field Visual Analytics was formally defined \cite{Fisher:2005}, \cite{KOHLHAMMER2011117}, the tools use to visualize data have evolved from desktop based to a new breed of virtual reality based apparatus which is some cases may facilitate the understanding as well as provide insights, into
...
Initiatives to bring together Visual Analytics and Virtual Reality \cite{Bach:2016:IAE:2992154.2996365}

We looked at the Unity3D platform and how they can bypass ArcGIS providing a lowering cost of entry to 3D rendering and animation \cite{5567608}

A FRAMEWORK FOR LOW-COST MULTI-PLATFORM VR AND AR SITE EXPERIENCES \cite{Wallgrun:2017:FRA}

New developments in immersive analysis\cite{Lu:2016:TowardsMobileImmersiveAnalysis:7932378}

HDMS and large displays With the advancement of supercomputing, the growing s-
cale and complexity of the data make some of these tasks chal-
lenging, which demands new hardware and software solutions. \cite{Nagao:HDMSLageTiledDisplay:7932374}

Immersive solutions for future Air Traffic Control and Management \cite{Cordeil:2016:ISF:3009939.3009944}

Google Cardboard: A virtual reality headset for \$10? \cite{doi:10.1119/1.4905824}

Interactive and Immersive 3D Visualization for ATC\cite{Bourgois252275}

Large-scale comparative visualisation of
sets of multidimensional data \cite{Wohl:2016:PCS}

THREE-DIMENSIONAL STEREOSCOPIC VISUALIZATION FOR AIR
TRAFFIC CONTROL INTERFACES: A PRELIMINARY STUDY\cite{Tavanti:2003:5731102}

Ferreira et al propose an automatic microassembly system assisted by vision servoing and virtual reality, where trajectories may be analysed in a 3D environment to optimise component placement in assemblies. A human operator interacts with a 3D environment generated by a CAD (Computer Aided Design) CAM (Computer Aided Machining) environment \cite{Ferreira:AutomaticMicroassembly:1306445}. 
\begin{figure}[tb]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
 \includegraphics[width=\columnwidth]{ferreira-model.jpg}
 \caption{A model of the human-machine interaction as described by Ferreira et al, 2013}
 \label{fig:sample}
\end{figure}

\begin{figure}[tb]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
 \includegraphics[width=\columnwidth]{FromDaDy-ConnectionToolForVisualDesignandMenuAxis.png}
 \caption{FromDaDy software screen capture showing connection tool for visual design and menu axis}
 \label{fig:sample}
\end{figure}

Challenges to Applying Virtual Reality Technology and Techniques to Visual Analytics \cite{May:1667670}
QUOTE - TODO CHANGE
However, visual analytics is focused on
the analytical process not the tools and technology. As such, any new methods, techniques,
and technologies need to show benefit to analysts working on real problems. Additionally,
the majority of visual analytics research funding is not focused on disruptive physical interface
technologies. Generally speaking, new technologies and techniques for visual analytics
need to function within the current analytical environment.
The purpose of this panel is to introduce the domain of visual analytics to the audience
and explore how and where VR/AR research can be adapted for use in visual analytics.
The panelists have been selected based on topic areas of research that have potential for
near term insertion or impact on visual analytics. This panel will focus on the hard issues of
defining what it will take to get VR technology introduced into the visual analytics research
funding stream.

evolution of visualtization methods, aid perceptual limitations involved in grasping large amounts of data.\cite{Olshannikova2015}

Safety aspects of air traffic control, how to incorporate Augmented Reality to aid decison-making\cite{Vinot:2014:TAR:2637406.2627598}

FromDaDy: Spreading Aircraft Trajectories Across Views to
Support Iterative Queries \cite{Hurter:5290707}

Incorporating air traffic strips for air traffic control \cite{Hurter:2012:SEA:2254556.2254598}

FromDaDy tool \cite{Hurter:5290707}

Procedures and use cases \cite{Andrienko:6102454}

Designing Visual Analytics Methods for Massive
Collections of Movement Data \cite{Andrienko:2560453720070101}

Bundled Visualization of Dynamic Graph and Trail \cite{Hurter:6636295}

Thus, the analysis in situation-aware and immersive
environments are promising directions. A Survey of Traffic Data Visualization\cite{Chen:7120975}

Development and application of an integrated traffic simulation
and multi-driving simulators\cite{SUN20151}

Integrating GIS, simulation models, and visualization in traffic impact analysis\cite{WANG2005471}

A Performance Analysis of EC2 Cloud Computing Services for Scientific Computing\cite{Simon:10.1007/978-3-642-12636-9_9}

Assessing the determinants of cloud computing adoption: An analysis of the manufacturing and services sectors \cite{OLIVEIRA2014497}

There is increasing scope in adoption of Immsersive Virtual Reality visualization techniques \cite{Marks:2014:THF:2683405.2683424}

Low-cost headsets boost virtual reality's lab appeal \cite{Castelvecchi:2016}

Affordable altered perspectives: Making augmented and virtual reality technology accessible \cite{Amer:6970345}

Cloud-Based UASs Traffic Management: Trajectory Tracking and Collision Avoidance \cite{Polia:Thesis:2018}

Cost of acquiring data is also lowering \cite{DBLP:journals/corr/MarinaKBHC16}

\begin{figure}[tb]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
 \includegraphics[width=\columnwidth]{ferreira-assembly.png}
 \caption{CAD CAM generated 3D environment as described by Ferreira et al, 2013}
 \label{fig:sample}
\end{figure}

Getting Around in Google Cardboard – Exploring Navigation
Preferences with Low-Cost mobile VR\cite{Powell:7859536}



%% if specified like this the section will be committed in review mode
\acknowledgments{
We wish to thank  Gennady and Natalia Andrienko for their guidance and Aidan Slingsby for the LaTex template used to write this literature review.}
