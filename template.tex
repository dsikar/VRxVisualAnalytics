...
%% Abstract section.
\abstract{In this paper we look at published studies in the fields of virtual reality and visual analytics, particularly trajectories, which temporal and spatial movement data seem well suited for the emerging interdisciplinary field sometimes referred to as \textit{Immersive Analytics}. We look at use cases and techniques in academic and commercial applications, general costs of these new lines of research and how accessible the virtual reality techniques described are to the researcher. %
} % end of abstract
...
\input{template-1-introduction.tex}
...
\input{template-3-UseCasesAndTechniques.tex}
...
\input{template-6-Conclusion.tex}
...
\input{template-7-acknowledgements.tex}
